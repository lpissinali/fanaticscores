    ...
    <div className={styles.featured}>
      ...
      <div className={styles.featuredTop}>
        <div className={styles.featuredMeta}>
          ...
          <span className={styles.compLabel}>{d.competition}</span>
  ...
  return (
    <div className={styles.section}>
      ...
      <div className={styles.h2hBar}>
        <span className={styles.h2hTeam}>{d.home.short}</span>
        <div className={styles.h2hTrack}>
          <div className={styles.h2hHome}  style={{ flex: homeWins / total }} />
          <div className={styles.h2hDraw}  style={{ flex: draws    / total }} />
          <div className={styles.h2hAway}  style={{ flex: awayWins / total }} />
        </div>
        <span className={styles.h2hTeam}>{d.away.short}</span>
      </div>
  ...
  return (
    <div className={styles.desktop}>
      ...
      <main className={styles.main}>
        ...
        {loading && (
          <div className={styles.placeholder}>Loading match…</div>
        )}
        {error && (
